  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getResourceType() != null) {
      joiner.add(String.format("%sresource_type%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getResourceType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `event_version` to the URL query string
    if (getEventVersion() != null) {
      joiner.add(String.format("%sevent_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEventVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `event_type` to the URL query string
    if (getEventType() != null) {
      joiner.add(String.format("%sevent_type%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getEventType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getResourceVersion() != null) {
      joiner.add(String.format("%sresource_version%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getResourceVersion()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getResource() != null) {
      for (String _key : getResource().keySet()) {
        joiner.add(String.format("%sresource%s%s=%s", prefix, suffix,
            ...
            getResource().get(_key), URLEncoder.encode(String.valueOf(getResource().get(_key)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
