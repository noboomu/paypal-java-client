...
public class AddressPortable {
  ...
  **/
  ...
  /**
   * Return true if this address_portable object is equal to o.
   */
  @Override
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getAddressLine1() != null) {
      joiner.add(String.format("%saddress_line_1%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAddressLine1()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `address_line_2` to the URL query string
    if (getAddressLine2() != null) {
      joiner.add(String.format("%saddress_line_2%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAddressLine2()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `address_line_3` to the URL query string
    if (getAddressLine3() != null) {
      joiner.add(String.format("%saddress_line_3%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAddressLine3()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `admin_area_4` to the URL query string
    if (getAdminArea4() != null) {
      joiner.add(String.format("%sadmin_area_4%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAdminArea4()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `admin_area_3` to the URL query string
    if (getAdminArea3() != null) {
      joiner.add(String.format("%sadmin_area_3%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAdminArea3()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `admin_area_2` to the URL query string
    if (getAdminArea2() != null) {
      joiner.add(String.format("%sadmin_area_2%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAdminArea2()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `admin_area_1` to the URL query string
    if (getAdminArea1() != null) {
      joiner.add(String.format("%sadmin_area_1%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAdminArea1()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
    ...
    if (getCountryCode() != null) {
      joiner.add(String.format("%scountry_code%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getCountryCode()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
